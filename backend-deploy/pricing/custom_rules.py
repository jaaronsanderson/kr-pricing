...
LARGE_SHEET_MIN_DIMENSION = 40.0  # Minimum of the two dimensions must be >= 40
LARGE_SHEET_MAX_DIMENSION = 72.0  # Maximum of the two dimensions must be >= 72
LARGE_SHEET_MINIMUM_VALUE = 550.0  # $550 minimum for large sheets (40x72+)
